package net.ent.entc.seingeuriesrping.view.utils;
...
public final class AffichageConsole {
    ...
    public static final String RESET_COULEUR = "\u001B[0m";
    ...
    public static void afficherErreur(final String msg) {
        final String message = String.format("%sErreur : %s%s", COULEUR_ROUGE, msg, RESET_COULEUR);
        AffichageConsole.afficherMessageAvecSautLigne(message);
    }


    /**
     * Méthode affichant un message de succès.
     *
     * @param msg message de succès à afficher.
     */
    public static void afficherSucces(final String msg) {
        final String message = String.format("%s %s%s", COULEUR_VERT, msg, RESET_COULEUR);
        AffichageConsole.afficherMessageAvecSautLigne(message);
    }
